#!/usr/bin/env python3
"""Generate logos/jsgames.svg for ES-DE.
...
recolor it via ${systemLogoColor}. Run:  python3 gen-logo.py > logos/jsgames.svg
"""

# 5x7 block glyphs for the letters in the wordmark.
GLYPHS = {
    'J': ["00010", "00010", "00010", "00010", "10010", "10010", "01100"],
